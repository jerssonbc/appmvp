...
app.factory('Auth',function(FURL,$firebaseAuth,$firebase){
	...
	var Auth={
		...
		crearPerfil:function(uid,usuario){
			...
			var perfilRef=$firebase(ref.child('perfil'));
			return perfilRef.$set(uid,perfil);
		},
		...
		registro:function(usuario){
			return auth.$createUser(
				...
				.then(function(data){
					return Auth.crearPerfil(data.uid,usuario);
				});
		},
		logout:function(){
			auth.$unauth();
		},
		cambiarPassword:function(usuario){
			return auth.$changePassword({email:usuario.email,oldPassword:usuario.oldpass,newPassword:usuario.newpass});
		},
		signedIn:function(){
	...
	auth.$onAuth(function(authData){
		if(authData){
			...
			Auth.usuario.perfil=$firebase(ref.child('perfil').child(authData.uid)).$asObject();
		}else{
